  ...
  return (
    <div className="works">
         <div className="left-services">
           ...
           <a href="https://drive.google.com/file/d/1BtRLMBF_MALEPDYib48TwaLMi2Kc09MD/view?usp=sharing" target="_blank"><button className="cv-btn" data-aos="flip-right">Download CV</button> </a>
       </div>
